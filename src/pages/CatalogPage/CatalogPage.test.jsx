...
describe('CatalogPage', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render page with title "Каталог товаров"', () => {
      renderWithRouter(<CatalogPage onAddToCart={mockOnAddToCart} />);
    ...
    it('should render main element with correct class', () => {
      const { container } = renderWithRouter(<CatalogPage onAddToCart={mockOnAddToCart} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('should maintain structure on re-render with same props', () => {
      const { container, rerender } = renderWithRouter(<CatalogPage onAddToCart={mockOnAddToCart} />);

      const initialMain = container.querySelector('main.catalog-page');
      expect(initialMain).toBeInTheDocument();

      // Re-render with same props
      rerender(<MemoryRouter><CatalogPage onAddToCart={mockOnAddToCart} /></MemoryRouter>);
